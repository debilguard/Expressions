...
namespace BussinesRuleEngine
{
    public static class Expression2
    {
        ...
        private static async Task<TResult> Execute<TResult>(string variables, string code)
        {
            ...
            ////ScriptState state = await CSharpScript.RunAsync(variables, Options, null, null);
        ...
        public static string BuildVariables(List<object> parameters)
        {
        ...
        public static List<object> ListParameters(params object[] parameters)
        {
